...
#define PDRAM_RD_ADDRESS		0x1000
...
static uint8_t spi_tx_buffer[160] = {
...
volatile static uint32_t cl_pdram_start = &spi_tx_buffer[0+hw_tst_length+by_tst_length+abort_fifo_length+rd_status_length+cf_pdram_lenght+rd_pdram_lenght+wr_pdram_lenght+write_var_num*4];
//
//
